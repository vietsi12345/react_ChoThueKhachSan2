        ...
        <div className="relative  text-left bg-white rounded-lg">
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <div>{adults} người lớn, {children} trẻ em</div>
            ...
            {dropdownOpen && (
                <div className="absolute left-0 mt-2 w-full bg-white border border-gray-300 rounded-lg p-4 shadow-lg z-10 "  >
                    ...
                    <div className="flex justify-between items-center mb-4">
                        <span>Trẻ em</span>
                        <div className="flex items-center gap-2">
                            <button onClick={() => handleChildrenChange(-1)} disabled={children <= 0} className="bg-gray-200 p-2 rounded-full">
                                <FaMinus />
                            </button>
                            <span>{children}</span>
                            <button onClick={() => handleChildrenChange(1)} className="bg-gray-200 p-2 rounded-full">
                                <FaPlus />
                            </button>
                        </div>
                    </div>
