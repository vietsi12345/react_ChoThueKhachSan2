...
export const UpdateHotel = ({ updateValues }) => {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(actions.updateHotel({ idHotel: updateValues.id, formData }))
        alert("Sửa khách sạn thành công");
        ...
        <Box sx={style}>
            <form onSubmit={handleSubmit}>
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                        <Button type="submit" variant='contained' fullWidth>Sửa khách sạn</Button>
                    </Grid>
                </Grid>
            </form>
        </Box>
